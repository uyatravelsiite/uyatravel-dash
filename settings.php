<?php
  ...
  require('retrieve_data_gen.php');
  require('retrieve_data_con.php');
      ...
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            ...
            <p class="card-text" id="site_title"><?php echo $siteTitle; ?></p>
            <h6 class="card-subtitle mb-1 fw-bold">About us</h6>
            <p class="card-text" id="site_about"><?php echo $siteAbout; ?></p>
          </div>
        </div>
        <!-- General settings modal -->
        <div class="modal fade" id="general-s" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
            <form id="general_s_form" action="settings_gen_action.php" method="post">
              ...
              <div class="col-lg-6">
                ...
                <div class="mb-4">
                  ...
                  <p class="card-text mb-1">
                    ...
                    <span id="pn1"><?php echo $pn1; ?></span>
                  </p>
                  <p class="card-text">
                    <i class="bi bi-telephone-fill"></i>
                    <span id="pn2"><?php echo $pn2; ?></span>
                  </p>
                </div>
                <div class="mb-4">
              ...
              <div class="col-lg-6">
                <div class="mb-4">
                  ...
                  <p class="card-text">
                    ...
                    <span id="tw"><?php echo $email; ?></span>
                  </p>
                </div>
                <div class="mb-4">
                  <h6 class="card-subtitle mb-1 fw-bold">iFrame</h6>
                  <p> <?php echo $iframeSrc; ?> </p>
        ...
        <div class="modal fade" id="contacts-s" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <form id="contacts_s_form" action="settings_con_action.php" method="post">
              <div class="modal-content">
                <div class="modal-header">
